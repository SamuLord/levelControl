...
template <> constexpr inline auto ClientHandler::qt_create_metaobjectdata<qt_meta_tag_ZN13ClientHandlerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onTimeoutRequest'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Method 'getData'
        QtMocHelpers::MethodData<void()>(10, 2, QMC::AccessPublic, QMetaType::Void),
        // Method 'sendData'
        QtMocHelpers::MethodData<void(const QJsonObject &)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
        ...
        // Method 'setIntervalTimer'
        QtMocHelpers::MethodData<void(const QString)>(16, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 17 },
        }}),
        // Method 'handlerTimerRequest'
        QtMocHelpers::MethodData<void(const bool)>(18, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 19 },
        }}),
        // Method 'getForcedRequest'
        QtMocHelpers::MethodData<bool() const>(20, 2, QMC::AccessPublic, QMetaType::Bool),
        // Method 'setForcedRequest'
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->requestError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->responseData((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 2: _t->onFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 3: _t->onTimeoutRequest(); break;
        case 4: _t->getData(); break;
        case 5: _t->sendData((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 6: _t->setAccessIP((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 7: { QString _r = _t->getAccessIP();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 8: _t->setIntervalTimer((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 9: _t->handlerTimerRequest((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 10: { bool _r = _t->getForcedRequest();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 11: _t->setForcedRequest((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(const QString & )>(_a, &ClientHandler::requestError, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(const QJsonObject & )>(_a, &ClientHandler::responseData, 1))
            return;
    }
}
...
// SIGNAL 0
void ClientHandler::requestError(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ClientHandler::responseData(const QJsonObject & _t1)
{
